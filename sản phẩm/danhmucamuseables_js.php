<script>
 document.addEventListener("DOMContentLoaded", function() {
        const products = <?php echo json_encode($categories['amuseables'] ?? []); ?>; // sửa key 'Animals' thành 'animals'
...
document.addEventListener("DOMContentLoaded", function() {
    const products = <?php echo json_encode($categories['amuseables'] ?? []); ?>; // Sử dụng JSON từ PHP
    const productContainer = document.querySelector('.shop.container');
