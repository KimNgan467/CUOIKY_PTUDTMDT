                ...
                <?php if (!empty($products)): ?>
                    <?php foreach ($products as $product): ?>
                        ...
                        <a href="chitietsp.php?id=<?php echo htmlspecialchars($product['id']); ?>">
                            <img style = "width: 50%;" class="product-img" src="Anh/<?php echo htmlspecialchars($product['image1']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
...
<div class="list-page">
    <div class="item"><a href="Danhmucanimals.html">1</a></div>
    <div class="item"><a href="danhmucamuseables.html">2</a></div>
    <div class="item"><a href="danhmucbags&charms.html">3</a></div>
    <div class="item"><a href="danhmucgifts.html">4</a></div>
</div>
<footer>
    <div class="container">
...
<?php include 'danhmucanimals_js.php';?>
</body>
</html>