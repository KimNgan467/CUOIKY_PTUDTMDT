<script>
 document.addEventListener("DOMContentLoaded", function() {
        const products = <?php echo json_encode($categories['animals'] ?? []); ?>; // sửa key 'Animals' thành 'animals'
...
document.addEventListener("DOMContentLoaded", function() {
    const products = <?php echo json_encode($categories['animals'] ?? []); ?>; // Sử dụng JSON từ PHP
    const productContainer = document.querySelector('.shop.container');
