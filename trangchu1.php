...
<body>
    ...
    <main>
        <div class="TVC">
            ...
            <div class="overlay">
                ...
                <a href="./sản phẩm/danhmucgifts.php">
  <button>Explore Christmas</button>
        ...
        <div class="product-grid">
            ...
            <a href="http://localhost/PHP/PTUD/s%E1%BA%A3n%20ph%E1%BA%A9m/chitietsp.php?id=8">
            ...
            <div class="product-card">
                <a href="http://localhost/PHP/PTUD/s%E1%BA%A3n%20ph%E1%BA%A9m/chitietsp.php?id=11">
